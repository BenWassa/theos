...
sources:
  - id: hin-practice-yogas
    type: scholarly
    text: 'The four classical paths (margas / yogas): bhakti, jnana, karma, and raja.'
  - id: hin-practice-darshan
    type: scholarly
    text: 'The practice of darshan (auspicious sight of the deity) and the festival cycle.'
review_status: draft
---
...
The underlying assumption is generous and unusual: that there is no single correct temperament for the spiritual life. The scholar, the servant, the lover, and the meditator are all going somewhere, and the tradition declines to tell them they must swap temperaments to arrive.
