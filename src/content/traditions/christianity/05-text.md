...
sources:
  - id: chr-text-ps130
    type: sacred-text
    text: 'Psalm 130:1, "Out of the depths I cry to you, O Lord," NRSV.'
  - id: chr-text-ps22
    type: sacred-text
    text: 'Psalm 22:1, the cry of dereliction, NRSV.'
  - id: chr-text-synth
    type: scholarly
    text: 'Illustrative synthesis of how devotional readers describe the Psalms. This must be replaced with a real, attributed first-person account before it can be marked reviewed.'
...
I used to think I was reading it. Now I am fairly sure it is reading me.
