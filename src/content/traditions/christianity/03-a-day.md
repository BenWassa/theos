...
sources:
  - id: chr-aday-missal
    type: documentary
    text: 'Structure and texts of the Roman Rite (The Roman Missal, third typical edition).'
  - id: chr-aday-synth
    type: scholarly
    text: 'Illustrative synthesis grounded in the documented order of Mass. Per the project sourcing rule, this narrative must be verified against, or replaced by, a real first-person account before it can be marked reviewed.'
