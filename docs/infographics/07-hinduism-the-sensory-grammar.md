...
```
┌──────────────────────────────┐
│        T H E   W I N D O W    │  ← diya + marigold photo, full-bleed top
│ ───────────────────────────  │
│  SENSORY WORLD · HINDUISM     │  ← kicker orange
│  The Sensory Grammar          │  ← serif title
│                               │
│   ◉ SIGHT   colour · the murti│  ← five sense-rows, each: a small orange
│   ◉ FIRE    the diya flame    │     marker + SENSE (sans) + its materials
│   ◉ SOUND   Om · bell · conch │     (serif). Warm, generous spacing.
│   ◉ SCENT   sandalwood·camphor│
│   ◉ TASTE   prasad, shared    │
│                               │
│  "to make the immeasurable    │  ← the closing line from the prose, serif
...
- Kicker: `SENSORY WORLD · HINDUISM`, sans orange `#fb923c`, `+0.22em`.
- Title: `The Sensory Grammar`, serif 500, `#fff7ed`.
- Sense labels: sans 500, 15px, `+0.14em`, `#fff7ed`; markers `#fb923c`.
- Materials: serif 400, 16px, `#c9a48a`.
- Closing quote line: serif italic 400, `#fff7ed`.
