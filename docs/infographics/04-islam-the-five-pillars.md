...
From the prose: *"Islam organises the whole of a life around five recurring acts,
and their genius is repetition. Faith is not asked to sustain itself on feeling;
...
```
┌──────────────────────────────┐
│        T H E   W I N D O W    │  ← aniconic photo, full-bleed top
│ ───────────────────────────  │
│  PRACTICE · ISLAM             │  ← kicker emerald
│  The Five Pillars             │  ← serif title
│                               │
│  █  Shahada   the declaration │  ← five vertical "pillars": a tall thin
│  █  Salah     five prayers/day│     emerald bar + name (serif) + one line
│  █  Zakat     the yearly share│     (sans muted). Bars literally stand as
│  █  Sawm      the month's fast│     five columns → the word "pillars" made
│  █  Hajj      the one journey │     visual.
│                               │
...
- Kicker: `PRACTICE · ISLAM`, sans emerald `#34d399`, `+0.22em`.
- Title: `The Five Pillars`, serif 500, `#ecfdf5`.
- Pillar names: serif 500, 22px, `#ecfdf5`.
- Pillar sub-lines: sans 400, 14px, `#89b3a3`.
- Numerals 1–5 (optional): sans 500, `#34d399`, at each column base.
