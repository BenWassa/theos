...
- **Subject:** light itself as the subject. Either (a) shafts of stained-glass
  colour falling across a stone floor/pew, or (b) a single lit candle glowing in
  a dark chapel. The image should feel *dark with one source of light*, matching
...
┌──────────────────────────────┐
│                               │
│        T H E   W I N D O W    │  ← light/candle photo, large, full-bleed top
│      (light falling in dark)  │
│                               │
│ ───────────────────────────  │
│  SENSORY WORLD · CHRISTIANITY │  ← kicker amber
│  Light in Sacred Space        │  ← serif title
│                               │
│   ◐ CATHEDRAL      ◦ CANDLE   │  ← two "scales of light" markers
│   sun → colour     one flame, │     small serif subheads + one line each
│   across stone     out-sized  │
│                               │
...
- Kicker: `SENSORY WORLD · CHRISTIANITY`, sans amber, `+0.22em`.
- Title: `Light in Sacred Space`, serif 500, `#e7e5e4`.
- Two subheads: `CATHEDRAL` / `CANDLE`, sans 500, 15px, `+0.16em`, one in
  `#e7e5e4`, the marker dot in `#f59e0b`.
- Supporting lines: serif 400, `#a8a29e`.
